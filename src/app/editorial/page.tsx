  ...
  const editorInChiefMembers = [
    {
      ...
      name: "Dr. Amol R. Bute",
      title:
        "Assistant Professor, Dept. of Basic Sciences & Humanities, GMR Institute of Technology, Rajam. Andhra Pradesh",
    ...
    },
    {
      ...
      title:
        "Assistant Professor, Department of English, NSSR'S Arts and Commerce College, Parli Vaijnath. Maharashtra",
  ...
  const advisoryBoardMembers = [
    {
      ...
      title:
        "Assistant Professor, Dept. of Humanities and Applied Sciences, VESIT, Chembur, Mumbai",
    ...
    },
    {
      ...
      title:
        "Associate Professor, Department of Commerce, Shivaji Mahavidyalaya, Renapur, Latur-413527",
  ...
  const editorialBoardMembers = [
    {
      ...
      title:
        "Retired Professor, Dept. of English, Smt. Radhabai Sarda Mahavidyalaya, Anjangaon Surji, Maharashtra",
    ...
    },
    {
      ...
      name: "Dr. Arpana Jha",
      title:
        "Assistant Professor, Dept. of English and Foreign Languages, Central University of South Bihar, Gaya, Bihar",
    ...
    },
    {
      ...
      title:
        "Professor, Dept. of English, G. S. Tompe Arts, Com & Sci College, Chandur Bazar, Maharashtra",
    ...
    },
    {
      ...
      title:
        "Professor, Dnyanopasak Shikshan Mandal's College of Arts, Commerce and Science, Parbhani, Maharashtra, India",
    ...
    <div className="bg-white min-h-screen">
      ...
      >
        <div className="bg-black bg-opacity-60 py-20 px-4">
          <h1 className="text-4xl  text-white mb-6 py-5">Editorial Board</h1>
